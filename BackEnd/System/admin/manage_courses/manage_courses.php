...
.tab-card-header > .tab-content {
 ...
 <!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="../admin_main.php">Allam learning</a>
      ...
      <div class="row">
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
			...
			<li class="list-group-item bg-dark "><a>Manage Courses</a></li>
          
		  <li class="list-group-item bg-dark"><a>Manage Videos</a></li>
